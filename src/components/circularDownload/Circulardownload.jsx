...
const CircularDownload = () => {
    ...
    const deleteCircular = async (fileurl) => {
        try {
            await axiosWithToken.put('https://circularhub-backend.onrender.com/admin-api/delete-circular', {
    ...
    const restoreCircular = async (fileurl) => {
        try {
            await axiosWithToken.put('https://circularhub-backend.onrender.com/admin-api/restore-circular', {
                fileurl // Send fileurl as data
            });
